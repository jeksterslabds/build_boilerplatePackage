...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpxuDQ4n/boilerplatePackage.Rcheck’
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (1.3s)
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (886ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (534ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (657ms)
    ...
    ##    checking examples ...  ✔  checking examples (397ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (738ms)
    ...
    ##   /tmp/RtmpxuDQ4n/boilerplatePackage_0.9.0.tar.gz --install-tests 
