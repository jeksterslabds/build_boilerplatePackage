...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmpr0Dxw7/boilerplatePackage.Rcheck’
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (1.5s)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (634ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (714ms)
    ...
    ##      checking examples ...  ✔  checking examples (507ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (891ms)
    ...
    ##   /tmp/Rtmpr0Dxw7/boilerplatePackage_0.9.0.tar.gz --install-tests 
