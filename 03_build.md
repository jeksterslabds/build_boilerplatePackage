...
```
    ...
    ##      creating vignettes ...  ✔  creating vignettes (2.1s)
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmpbp94Zc/boilerplatePackage.Rcheck’ (476ms)
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (1.7s)
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (2.5s)
    ...
    ##    checking index information ...  ✔  checking index information (498ms)
    ##      checking package subdirectories ...  ✔  checking package subdirectories (505ms)
    ...
    ##    checking whether the package can be loaded ...  ✔  checking whether the package can be loaded (416ms)
    ...
    ##    checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (1.2s)
    ...
    ##      checking R code for possible problems ...  ✔  checking R code for possible problems (3.4s)
    ##      checking Rd files ...  ✔  checking Rd files (344ms)
    ...
    ##      checking for code/documentation mismatches ...  ✔  checking for code/documentation mismatches (641ms)
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (1.5s)
    ...
    ##      checking data for non-ASCII characters ...  ✔  checking data for non-ASCII characters (387ms)
    ##      checking data for ASCII and uncompressed saves ...  ✔  checking data for ASCII and uncompressed saves (358ms)
    ##   ✔  checking installed files from ‘inst/doc’
    ##    checking files in ‘vignettes’ ...  ✔  checking files in ‘vignettes’
    ##    checking examples ...  ✔  checking examples (960ms)
    ##      checking for unstated dependencies in ‘tests’ ...  ✔  checking for unstated dependencies in ‘tests’
    ##      checking tests ...  ─  checking tests (391ms)
    ##      Running ‘testthat.R’    ✔  Running ‘testthat.R’ (2.7s)
    ##      checking for unstated dependencies in vignettes ...  ✔  checking for unstated dependencies in vignettes (3.1s)
    ##   ✔  checking package vignettes in ‘inst/doc’
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (1.5s)
    ##   ✔  checking for non-standard things in the check directory
    ## ✔  checking for detritus in the temp directory
    ##    
    ##    
    ##      checking for file ‘/media/jeksterslab/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION’ ...  ✔  checking for file ‘/media/jeksterslab/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION’ (393ms)
    ##   ─  preparing ‘boilerplatePackage’:
    ##      checking DESCRIPTION meta-information ...  ✔  checking DESCRIPTION meta-information
    ##   ─  checking for LF line-endings in source and make files and shell scripts
    ##   ─  checking for empty or unneeded directories
    ...
    ##   /tmp/Rtmpbp94Zc/boilerplatePackage_0.9.0.tar.gz --install-tests 
