...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpOfezVN/boilerplatePackage.Rcheck’
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (987ms)
    ...
    ##      checking examples ...  ✔  checking examples (370ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (655ms)
    ...
    ##   /tmp/RtmpOfezVN/boilerplatePackage_0.9.0.tar.gz --install-tests 
