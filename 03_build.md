...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpTlaIjK/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (917ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (579ms)
    ...
    ##      checking examples ...  ✔  checking examples (445ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (819ms)
    ...
    ##   /tmp/RtmpTlaIjK/boilerplatePackage_0.9.0.tar.gz --install-tests 
