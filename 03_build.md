...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpmyaiPF/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (903ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (600ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (622ms)
    ...
    ##    checking examples ...  ✔  checking examples (479ms)
    ...
    ##      checking for unstated dependencies in vignettes ...  ✔  checking for unstated dependencies in vignettes (1.6s)
    ##   ✔  checking package vignettes in ‘inst/doc’
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (820ms)
    ...
    ##   /tmp/RtmpmyaiPF/boilerplatePackage_0.9.0.tar.gz --install-tests 
