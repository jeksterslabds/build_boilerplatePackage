...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmp3gCy1c/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (867ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (499ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (580ms)
    ...
    ##      checking examples ...  ✔  checking examples (380ms)
    ...
    ##   /tmp/Rtmp3gCy1c/boilerplatePackage_0.9.0.tar.gz --install-tests 
