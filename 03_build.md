...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpEi0xi6/boilerplatePackage.Rcheck’
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (984ms)
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (778ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (458ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (501ms)
    ...
    ##   /tmp/RtmpEi0xi6/boilerplatePackage_0.9.0.tar.gz --install-tests 
