...
```
    ...
    ##      creating vignettes ...  ✔  creating vignettes (892ms)
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpVS2Fjm/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (614ms)
    ...
    ##    checking      checking whether the namespace can be unloaded cleanly ...  ✔  checking whether the namespace can be unloaded cleanly
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (414ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (483ms)
    ...
    ##   /tmp/RtmpVS2Fjm/boilerplatePackage_0.9.0.tar.gz --install-tests 
