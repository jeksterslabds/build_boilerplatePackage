...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpFOZ2xC/boilerplatePackage.Rcheck’
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (690ms)
    ...
    ##      checking R code for possible problems ...  ✔  checking R code for possible problems (1.8s)
    ...
    ##    checking      checking for code/documentation mismatches ...  ✔  checking for code/documentation mismatches (369ms)
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (755ms)
    ...
    ##      checking examples ...  ✔  checking examples (536ms)
    ...
    ##      checking for unstated dependencies in vignettes ...  ✔  checking for unstated dependencies in vignettes (1.8s)
    ##      checking package vignettes in ‘inst/doc’ ...  ✔  checking package vignettes in ‘inst/doc’
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (969ms)
    ...
    ##   /tmp/RtmpFOZ2xC/boilerplatePackage_0.9.0.tar.gz --install-tests 
