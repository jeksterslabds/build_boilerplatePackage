...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmp92U0AW/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (830ms)
    ...
    ##    checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (584ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (524ms)
    ...
    ##      checking examples ...  ✔  checking examples (392ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (866ms)
    ...
    ##   /tmp/Rtmp92U0AW/boilerplatePackage_0.9.0.tar.gz --install-tests 
