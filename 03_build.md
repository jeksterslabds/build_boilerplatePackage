...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpOitnRE/boilerplatePackage.Rcheck’
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (793ms)
    ##      checking installed package size ...  ✔  checking installed package size
    ##   ✔  checking package directory
    ##      checking for future file timestamps ...  ✔  checking for future file timestamps (1.7s)
    ...
    ##    checking      checking R files for syntax errors ...  ✔  checking R files for syntax errors
    ...
    ##    checking      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (545ms)
    ...
    ##    checking for code/documentation mismatches ...  ✔  checking for code/documentation mismatches (338ms)
    ##    checking Rd \usage sections     checking Rd \usage sections ...  ✔  checking Rd \usage sections (652ms)
    ...
    ##      checking examples ...  ✔  checking examples (458ms)
    ##      checking for unstated dependencies in ‘tests’ ...  ✔  checking for unstated dependencies in ‘tests’
    ##    checking tests ...  ─  checking tests
    ##      Running ‘testthat.R’    ✔  Running ‘testthat.R’ (1.6s)
    ##      checking for unstated dependencies in vignettes ...  ✔  checking for unstated dependencies in vignettes (1.9s)
    ##   ✔  checking package vignettes in ‘inst/doc’
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (890ms)
    ...
    ##   /tmp/RtmpOitnRE/boilerplatePackage_0.9.0.tar.gz --install-tests 
