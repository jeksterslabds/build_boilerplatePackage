...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpEtjZcq/boilerplatePackage.Rcheck’
    ## ─  using R version 3.6.3 (2020-02-29)
    ##   ─  using platform: x86_64-pc-linux-gnu (64-bit)
    ## ─  using session charset: UTF-8
    ##   ─  using options ‘--no-manual --as-cran’
    ##      checking for file ‘boilerplatePackage/DESCRIPTION’ ...  ✔  checking for file ‘boilerplatePackage/DESCRIPTION’
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (892ms)
    ##    checking installed package size ...  ✔  checking installed package size
    ##   ✔  checking package directory
    ##      checking for future file timestamps ...  ✔  checking for future file timestamps (3.5s)
    ##   ✔  checking ‘build’ directory
    ##    checking DESCRIPTION meta-information ...  ✔  checking DESCRIPTION meta-information
    ##    checking   ✔  checking top-level files
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (616ms)
    ...
    ##      checking R code for possible problems ...  ✔  checking R code for possible problems (1.7s)
    ...
    ##    checking for code/documentation mismatches ...  ✔  checking for code/documentation mismatches (348ms)
    ##    checking Rd \usage sections     checking Rd \usage sections ...  ✔  checking Rd \usage sections (718ms)
    ...
    ##      checking examples ...  ✔  checking examples (505ms)
    ##      checking for unstated dependencies in ‘tests’ ...  ✔  checking for unstated dependencies in ‘tests’
    ##    checking tests ...  ─  checking tests
    ##      Running ‘testthat.R’    ✔  Running ‘testthat.R’ (1.5s)
    ##      checking for unstated dependencies in vignettes ...  ✔  checking for unstated dependencies in vignettes (1.7s)
    ##   ✔  checking package vignettes in ‘inst/doc’
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (848ms)
    ...
    ##   /tmp/RtmpEtjZcq/boilerplatePackage_0.9.0.tar.gz --install-tests 
