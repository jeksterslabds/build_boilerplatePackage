...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpiYo2AW/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (843ms)
    ...
    ##    checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (493ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (531ms)
    ...
    ##   /tmp/RtmpiYo2AW/boilerplatePackage_0.9.0.tar.gz --install-tests 
