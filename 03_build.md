...
```
    ...
    ## Path: /home/jek/scripts/r/build_boilerplatePackage/boilerplatePackage
...
```
    ...
    ## Updating roxygen version in /home/jek/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION
    ...
    ## Warning in value[[3L]](cond): Error rendering /home/jek/scripts/r/build_boilerplatePackage/boilerplatePackage/tests/testthat/test_z.R
    ...
    ## ────────────────────────────────────────────────────────────────────────────────
    ##      checking for file ‘/home/jek/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION’ ...  ✔  checking for file ‘/home/jek/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION’
    ##   ─  preparing ‘boilerplatePackage’:
    ##      checking DESCRIPTION meta-information ...  ✔  checking DESCRIPTION meta-information
    ##   ─  installing the package to build vignettes
    ##      creating vignettes ...  ✔  creating vignettes (971ms)
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpMHzKUK/boilerplatePackage.Rcheck’
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (4.5s)
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (627ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (430ms)
    ##    checking replacement functions ...  ✔  checking replacement functions
    ##    checking      checking foreign function calls ...  ✔  checking foreign function calls
    ##      checking R code for possible problems ...  ✔  checking R code for possible problems (1.4s)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (554ms)
    ...
    ##      checking examples ...  ✔  checking examples (443ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (720ms)
    ...
    ##   /tmp/RtmpMHzKUK/boilerplatePackage_0.9.0.tar.gz --install-tests 
