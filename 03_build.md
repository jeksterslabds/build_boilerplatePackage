...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmpz1u5Cs/boilerplatePackage.Rcheck’
    ...
    ##    checking      checking whether the package can be loaded ...  ✔  checking whether the package can be loaded
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (513ms)
    ...
    ##      checking examples ...  ✔  checking examples (352ms)
    ...
    ##   /tmp/Rtmpz1u5Cs/boilerplatePackage_0.9.0.tar.gz --install-tests 
