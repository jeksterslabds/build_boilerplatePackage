...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpgWOEWZ/boilerplatePackage.Rcheck’
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (622ms)
    ...
    ##    checking for code/documentation mismatches ...  ✔  checking for code/documentation mismatches (343ms)
    ##        checking Rd \usage sections ...  ✔  checking Rd \usage sections (735ms)
    ...
    ##      checking examples ...  ✔  checking examples (468ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (940ms)
    ...
    ##   /tmp/RtmpgWOEWZ/boilerplatePackage_0.9.0.tar.gz --install-tests 
