...
```
    ...
    ## Warning in value[[3L]](cond): Error rendering /home/jek/scripts/r/build_boilerplatePackage/boilerplatePackage/README.Rmd
    ...
    ##      creating vignettes ...  ✔  creating vignettes (1s)
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmph1Eh2L/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (1s)
    ...
    ##    checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (454ms)
    ...
    ##    checking Rd \usage sections ...  ✔  checking Rd \usage sections (539ms)
    ...
    ##    checking      checking contents of ‘data’ directory ...  ✔  checking contents of ‘data’ directory
    ...
    ##      checking examples ...  ✔  checking examples (431ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (692ms)
    ...
    ##   /tmp/Rtmph1Eh2L/boilerplatePackage_0.9.0.tar.gz --install-tests 
