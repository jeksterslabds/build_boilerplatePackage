...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpnuKfD7/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (883ms)
    ##      checking installed package size ...  ✔  checking installed package size
    ##      checking package directory ...  ✔  checking package directory
    ##    checking for future file timestamps ...  ✔  checking for future file timestamps (3.6s)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (529ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (593ms)
    ...
    ##      checking examples ...  ✔  checking examples (405ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (735ms)
    ...
    ##   /tmp/RtmpnuKfD7/boilerplatePackage_0.9.0.tar.gz --install-tests 
