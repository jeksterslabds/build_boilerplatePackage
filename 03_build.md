...
```
    ...
    ##      creating vignettes ...  ✔  creating vignettes (1.5s)
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpG7gy2n/boilerplatePackage.Rcheck’
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (618ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (718ms)
    ...
    ##      checking examples ...  ✔  checking examples (501ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (961ms)
    ...
    ##   /tmp/RtmpG7gy2n/boilerplatePackage_0.9.0.tar.gz --install-tests 
