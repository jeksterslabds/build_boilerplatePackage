...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpaP1bpS/boilerplatePackage.Rcheck’
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (851ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (497ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (618ms)
    ...
    ##      checking examples ...  ✔  checking examples (402ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (747ms)
    ...
    ##   /tmp/RtmpaP1bpS/boilerplatePackage_0.9.0.tar.gz --install-tests 
