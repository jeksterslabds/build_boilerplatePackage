...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpGsW2jP/boilerplatePackage.Rcheck’
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (571ms)
    ...
    ##      checking examples ...  ✔  checking examples (406ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (748ms)
    ...
    ##   /tmp/RtmpGsW2jP/boilerplatePackage_0.9.0.tar.gz --install-tests 
