...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpYporXF/boilerplatePackage.Rcheck’
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (446ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (506ms)
    ...
    ##   /tmp/RtmpYporXF/boilerplatePackage_0.9.0.tar.gz --install-tests 
