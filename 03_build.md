...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpIAgC6I/boilerplatePackage.Rcheck’
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (909ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (504ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (637ms)
    ...
    ##      Running ‘testthat.R’    ✔  Running ‘testthat.R’ (1.4s)
    ##      checking for unstated dependencies in vignettes ...  ✔  checking for unstated dependencies in vignettes (1.7s)
    ##   ✔  checking package vignettes in ‘inst/doc’
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (934ms)
    ##    checking   ✔  checking for detritus in the temp directory
    ##    
    ##    
    ##      checking for file ‘/media/jeksterslab/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION’ ...  ✔  checking for file ‘/media/jeksterslab/scripts/r/build_boilerplatePackage/boilerplatePackage/DESCRIPTION’
    ##   ─  preparing ‘boilerplatePackage’:
    ...
    ##   /tmp/RtmpIAgC6I/boilerplatePackage_0.9.0.tar.gz --install-tests 
