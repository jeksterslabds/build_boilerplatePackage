...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpbuFQdU/boilerplatePackage.Rcheck’
    ...
    ##    checking package dependencies ...  ✔  checking package dependencies (992ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (457ms)
    ...
    ##    checking Rd \usage sections ...  ✔  checking Rd \usage sections (514ms)
    ...
    ##   /tmp/RtmpbuFQdU/boilerplatePackage_0.9.0.tar.gz --install-tests 
