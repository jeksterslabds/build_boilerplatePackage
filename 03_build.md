...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpNTuAwZ/boilerplatePackage.Rcheck’
    ...
    ##    checking for future file timestamps ...  ✔  checking for future file timestamps (2.3s)
    ...
    ##    checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (536ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (590ms)
    ...
    ##      checking examples ...  ✔  checking examples (410ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (765ms)
    ...
    ##   /tmp/RtmpNTuAwZ/boilerplatePackage_0.9.0.tar.gz --install-tests 
