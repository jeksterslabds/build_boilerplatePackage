...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmpv5ZhwG/boilerplatePackage.Rcheck’
    ##    using R version 4.0.0 (2020-04-24)  ─  using R version 4.0.0 (2020-04-24)
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (866ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (528ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (561ms)
    ...
    ##      checking examples ...  ✔  checking examples (386ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (746ms)
    ...
    ##   /tmp/Rtmpv5ZhwG/boilerplatePackage_0.9.0.tar.gz --install-tests 
