...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpYycNvp/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (800ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (642ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (526ms)
    ...
    ##      checking examples ...  ✔  checking examples (457ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (776ms)
    ...
    ##   /tmp/RtmpYycNvp/boilerplatePackage_0.9.0.tar.gz --install-tests 
