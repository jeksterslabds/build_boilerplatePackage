...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/Rtmp6pFimZ/boilerplatePackage.Rcheck’
    ...
    ##    checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (768ms)
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (438ms)
    ...
    ##      checking examples ...  ✔  checking examples (353ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (652ms)
    ...
    ##   /tmp/Rtmp6pFimZ/boilerplatePackage_0.9.0.tar.gz --install-tests 
