...
```
    ...
    ## ● NOT_CRAN                          : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##   ─  using log directory ‘/tmp/RtmpJsnMSp/boilerplatePackage.Rcheck’
    ...
    ##      checking whether package ‘boilerplatePackage’ can be installed ...  ✔  checking whether package ‘boilerplatePackage’ can be installed (710ms)
    ...
    ##    checking whether the package can be loaded with stated dependencies     checking whether the package can be loaded with stated dependencies ...  ✔  checking whether the package can be loaded with stated dependencies
    ...
    ##      checking S3 generic/method consistency ...  ✔  checking S3 generic/method consistency (489ms)
    ...
    ##      checking Rd \usage sections ...  ✔  checking Rd \usage sections (563ms)
    ...
    ##      checking examples ...  ✔  checking examples (390ms)
    ...
    ##      checking re-building of vignette outputs ...  ✔  checking re-building of vignette outputs (713ms)
    ...
    ##   /tmp/RtmpJsnMSp/boilerplatePackage_0.9.0.tar.gz --install-tests 
